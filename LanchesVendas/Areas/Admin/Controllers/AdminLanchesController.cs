...
namespace LanchesVendas.Areas.Admin.Controllers
{
    ...
    public class AdminLanchesController : Controller
    {
        ...
        public AdminLanchesController(AplicandoDbContext context)
        {
            _context = context;
        }
        ...
        {
            var aplicandoDbContext = _context.Lanches.Include(l => l.Categoria);
            return View(await aplicandoDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("LancheId,LancheNome,Preco,Descricao,ImagemUrl,LancheDoDia,CategoriaId")] Lanche lanche)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LancheId,LancheNome,Preco,Descricao,ImagemUrl,LancheDoDia,CategoriaId")] Lanche lanche)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AplicandoDbContext.Lanches'  is null.");
            }
            var lanche = await _context.Lanches.FindAsync(id);
            if (lanche != null)
            {
